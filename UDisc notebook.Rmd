...
plot(1:9, Front_Nine_Avgs, xlab = "Hole #", ylab = "Avg Strokes (Lower is Better)", xlim = c(1,9), ylim = c(Ylim_One, Ylim_Two), main = paste("Avg strokes on the nth hole for:", Just_One_Name ),text(1:9, Front_Nine_Avgs-.03, round(Front_Nine_Avgs, 2)), ) 
...
plot(1:9, Rel_Score, xlab = "Hole #", ylab = "Avg Score (Lower is Better)", xlim = c(1,9), ylim = c(Ylim_Rel_One, Ylim_Rel_Two), main = paste("Avg score on the nth hole for:", Just_One_Name ),text(1:9, Rel_Score -.03, round(Rel_Score, 2)), )
